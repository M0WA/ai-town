"""
Blender 4.3 headless pipeline: car_hatchback FBX -> B3D (LOD0 + LOD1)
...
FBX_PATH      = "/tmp/hatchback_import/beige+hatchback+3d+model.fbx"
...
OUT_LOD0      = "/workspace/assets/3d/vehicles/car_hatchback_lod0.b3d"
OUT_LOD1      = "/workspace/assets/3d/vehicles/car_hatchback_lod1.b3d"
...
def main():
    print("=" * 60)
    print("AI Town — car_hatchback FBX -> B3D LOD conversion")
