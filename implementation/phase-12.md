...
- [ ] **Performance**: 60 FPS on mid-range desktop GPU with 10,000 vehicle agents; ≤2,000 draw calls per frame; simultaneous scene texture VRAM ≤170 MB (per Phase 9 budget table — this is the working scene budget); total resident texture VRAM ≤1.0 GB ceiling (GPU headroom on 4 GB card). Both constraints must hold simultaneously. (ref: `architecture/game-design/minimum-viable-simulation.md`, `architecture/asset-standards/2d-texture-standards.md`)
