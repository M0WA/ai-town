...
//   slot 4:  m_hud->getFinances()->draw()    -> kFinancesSentinel
...
constexpr UIElementHandle kFinancesSentinel     = 0xDEAD0103u;  // FinancesPanel   — slot 4
