...
> **SUPERSEDED by phase-11e:** Effective UV island resolution is now **496×496 px** per variant cell (512×512 cell minus 8 px border on each side × 2). The '256×256 effective per island' figure in this sign-off reflects the pre-phase-11e shared-cell design and is no longer valid. Current atlas: 8×8 grid, 512×512 px per cell.
