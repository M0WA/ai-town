...
# Phase 11q11: AITOWN_TESTING_ENABLED required on both simulation_tests and aitown_sim
# so that CitySimulation::testSetZoneDemandFactor() (gated on #ifdef AITOWN_TESTING_ENABLED)
# is compiled into the library and visible to ZoningTestNice. MUST NOT be set on aitown.
...
# Phase 11q12: MeshFormatUtilsTest — resolveModelPath() PLY/B3D format selection tests.
