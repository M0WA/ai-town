...
- **Windows CI**: Ninja generator (not MSBuild). DLL output at `build/` (not `build/Release/`). `ilammy/msvc-dev-cmd@a102174a2b586eec2ea151a69e6fd14404a8ce7c` runs vcvarsall before configure.
