"""
Blender 4.3 headless pipeline: car_suv FBX -> B3D (LOD0 + LOD1)
...
FBX_PATH      = "/tmp/suv_import/90s+suv+3d+model.fbx"
...
OUT_LOD0      = "/workspace/assets/3d/vehicles/car_suv_lod0.b3d"
OUT_LOD1      = "/workspace/assets/3d/vehicles/car_suv_lod1.b3d"
...
def main():
    print("=" * 60)
    print("AI Town — car_suv FBX -> B3D LOD conversion")
