...
audioSystem->syncListenerToCamera();  // commit camera position to OpenAL listener (Phase 7)
audioSystem->update();                // process audio command queue with updated listener (Phase 7 — see src/rendering/render_system.h comment; ref: implementation/phase-7.md line 31)
