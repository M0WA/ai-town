...
public:
    ...
    // Returns 0.0f for all tiles — height queries are not required by any Phase 9b
    // unit test that uses ManualTerrainQuery (tests use MockRenderer for renderer path).
